          ...
          <article className="feeds">
            <div className="feeds-top">
              <div className="feeds-top-left">
                <div><img src="images/rudy.jpeg" id="profile-img" alt="프로필 이미지" /></div>
                <span className="nickname">im__rudy</span>
              </div>
              <div className="feeds-top-right"><i className="fa-solid fa-ellipsis" /></div>
            </div>
            <img src="images/rudy.jpeg" alt="피드 이미지" id="feed-img" width="500px" height="500px" />
          ...
          <div className="main-right">
            <div className="ad">
              <div className="ad-contents">
                <img src="images/rudy.jpeg" id="profile-img" alt="프로필 이미지" />
              </div>
              <div className="ad-contents">
